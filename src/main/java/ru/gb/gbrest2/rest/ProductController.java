...
import ru.gb.gbrest2.service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<?> handleUpdate(@Validated @PathVariable("productId") Long id, @RequestBody ProductDto productDto) {
        productDto.setId(id);
